...
\documentclass[
    ...
    Topic           = 数据安全及隐私,
    ColaboratorName = 陈积明教授、孙铭阳研究员,
    % Title
    Title           = 面向流通场景的数据安全关键技术研究,
    TitleEng        = {{Research on key technologies of data security for circulation scenarios}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{面向流通场景的}{数据安全关键技术研究}
\titleengtwolines{Research on key technologies of}{data security for circulation scenarios}
