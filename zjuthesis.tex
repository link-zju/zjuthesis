...
\documentclass[
    ...
    TitleEng        = {{Research on Key Technology of Data Security in Data Circulation}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{面向流通场景的}{数据安全关键技术研究}
\titleengtwolines{Research on Key Technology of}{Data Security in Data Circulation}
